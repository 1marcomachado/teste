(function(){
  ...
  // Aguarda que o HTML base esteja carregado para evitar erros de elementos não encontrados
  document.addEventListener('DOMContentLoaded', () => {
    
    // 1. Nova lógica para apanhar o SKU especificamente no site da BZR
    let sku = "";
    ...
    if (!sku) return; // Se continuar sem encontrar, aborta em segurança
    ...
    // 2. Correção do evento do Slider para jQuery
    if (window.jQuery) {
