(function () {
  ...
  // Catálogo completo de 174 produtos Havaianas com Unicode escapes
  const rawProducts = [
  {
    "id": "409806",
  ...
  {
    "id": "409202",
    "name": "Chinelos Havaianas Top S\u00e3o Lu\u00eds Brancos e Azuis",
    "price": "29,99 \u20ac",
  ...
  {
    "id": "409213",
    "name": "Sand\u00e1lias Havaianas Flash Fusion Pretas e Bege",
    "price": "37,99 \u20ac",
  ...
  {
    "id": "212441",
    "name": "Sand\u00e1lias Havaianas Luna Rosa",
    "price": "24,90 \u20ac",
  ...
  {
    "id": "180974",
    "name": "Sand\u00e1lias Havaianas Flash Urban Pretas",
    "price": "25,99 \u20ac",
  ...
  {
    "id": "409008",
    "name": "Sand\u00e1lias Havaianas Baby Disney Classics II Azuis",
    "price": "20,99 \u20ac",
  ...
  {
    "id": "378534",
    "name": "Sand\u00e1lias Havaianas Baby A Porquinha Peppa Amarelas",
    "price": "20,99 \u20ac",
  ...
  {
    "id": "378355",
    "name": "Sand\u00e1lias Havaianas Baby Disney Classics II Amarelas",
    "price": "20,99 \u20ac",
  ...
  {
    "id": "181089",
    "name": "Sand\u00e1lias Havaianas Luna Pretas",
    "price": "30,99 \u20ac",
  ...
  {
    "id": "239680",
    "name": "Sand\u00e1lias Havaianas Luna Premium II",
    "price": "35,00 \u20ac",
  ...
  {
    "id": "181496",
    "name": "Sand\u00e1lias Havaianas Twist",
    "price": "28,99 \u20ac",
  ...
  {
    "id": "23847",
    "name": "Sand\u00e1lias Havaianas Flash Urban Bronze",
    "price": "25,99 \u20ac",
  ...
  {
    "id": "409012",
    "name": "Sand\u00e1lias Havaianas Baby Disney Classics II Laranja",
    "price": "20,99 \u20ac",
  ...
  {
    "id": "378358",
    "name": "Sand\u00e1lias Havaianas Baby Disney Classics II Rosa",
    "price": "20,99 \u20ac",
  ...
  {
    "id": "378336",
    "name": "Chinelos Havaianas Top Tropicalia Vibes Salm\u00e3o",
    "price": "25,99 \u20ac",
  ...
  if ($('#mm-promo-card-style').length === 0) {
    $('head').append(`
      <style id="mm-promo-card-style">
        ...
        #mm-minicart-promo-card .mm-products-grid, #mm-reccart-promo-card .mm-products-grid { display: flex; overflow: hidden; position: relative; width: 100%; gap: 0; }
        ...
        #mm-minicart-promo-card .mm-product-card.active, #mm-reccart-promo-card .mm-product-card.active { display: flex; }
  ...
  // ATUALIZA PROGRESSO EM QUALQUER POPUP
  ...
  function injectPromoCard($popup, cardId) {
    ...
    // Evitar duplicados no mesmo popup
    if ($popup.find(cardId).length > 0) {
      updatePromoCardProgress($popup.find(cardId));
      return;
    }
  ...
  function reattachObserver() {
    ...
    if (miniCartEl) {
      popupObserver.observe(miniCartEl, { childList: true, subtree: true });
    }
    
    const recCartEl = document.getElementById('recomendation-cart-right-bar');
    if (recCartEl) {
      popupObserver.observe(recCartEl, { childList: true, subtree: true });
    }
  }

  // MutationObserver local unificado para observar modificações em ambos os painéis
  const popupObserver = new MutationObserver(function () {
    ...
    // 2. Painel 2: Recomendação Add-to-cart
  ...
  function initPromo() {
    ...
    // Iniciar a observação das divs dos popups no DOM
    reattachObserver();
    
    // Injeção imediata se já estiverem visíveis
    const $miniCart = $('#rdc-mini-cart');
    if ($miniCart.length > 0 && $miniCart.is(':visible')) {
      injectPromoCard($miniCart, '#mm-minicart-promo-card');
    }
