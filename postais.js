  if ($('#mm-sugestoes').length === 0) {
    $(".wrapper-shoppingbag-product-list").append('<a class="button" id="mm-sugestoes" style="width: 100%;font-size: 16px;padding-top: 12px;padding-bottom: 12px;vertical-align: middle;background: none;color: black;display: flex;align-items: center;border-radius: 5px;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-gift"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M3 8m0 1a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-16a1 1 0 0 1 -1 -1z"></path><path d="M12 8l0 13"></path><path d="M19 12v7a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-7"></path><path d="M7.5 8a2.5 2.5 0 0 1 0 -5a4.8 8 0 0 1 4.5 5a4.8 8 0 0 1 4.5 -5a2.5 2.5 0 0 1 0 5"></path></svg><span style="margin-left: 10px;">Supreende a tua mãe</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-caret-down" style="margin-left: auto;"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M18 9c.852 0 1.297 .986 .783 1.623l-.076 .084l-6 6a1 1 0 0 1 -1.32 .083l-.094 -.083l-6 -6l-.083 -.094l-.054 -.077l-.054 -.096l-.017 -.036l-.027 -.067l-.032 -.108l-.01 -.053l-.01 -.06l-.004 -.057v-.118l.005 -.058l.009 -.06l.01 -.052l.032 -.108l.027 -.067l.07 -.132l.065 -.09l.073 -.081l.094 -.083l.077 -.054l.096 -.054l.036 -.017l.067 -.027l.108 -.032l.053 -.01l.06 -.01l.057 -.004l12.059 -.002z"></path></svg></a>');
  }
  ...
  $(document).on('click', '#mm-sugestoes', function(e) {
    ...
    $(".rdc-wrapper-bar-header-title").html("Escolhe um postal");
    $(".rdc-wrapper-bar-header-desc").html("Este dia da mãe oferece um complemento especial:");
    $(".rdc-wrapper-popup-header-title").html("Escolhe um postal");
    $(".rdc-wrapper-popup-header-desc").html("Este dia da mãe oferece um complemento especial:");
    $("#oferta_id").remove();
